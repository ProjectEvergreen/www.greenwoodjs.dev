    ...
    this.innerHTML = `
      <header class="${styles.container}">
        ...
        <nav class="${styles.navBar}">
          ...
          <button class="${styles.mobileMenuIcon}" popovertarget="my-popover">
            ${mobileMenuIcon}
          </button>
        </nav>
        ...
        <div id="my-popover" popover="manual">
          <div class="${styles.mobileMenuBackdrop}">
            ...
            <button class="${styles.mobileMenuCloseButton}" popovertarget="my-popover" popovertargetaction="hide">
              &times;
            </button>
