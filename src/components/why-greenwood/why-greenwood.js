      ...
      <div class="${styles.container}">
        ...
        <div class="${styles.cardContainer}">
          <div class="${styles.card}">
            ...
            <p>We believe a tech stack aligned to web standards can benefit from needing fewer dependencies and toolchains, lowered design and decision fatigue, and reduced layers of abstraction.  <em>Magic</em> is a zero interest rate phenomenon.</p>
          </div>

          <div class="${styles.card}">
            <!-- Transparent -->
            <h3>${placeholderIcon} Ship Your Source</h3>
            <p>We strive to ensure that you can ship exactly the code you wrote and combined with a fast, unbundled, local development experience, Greenwood will have you shipping in no time.  Greenwood aims to externalize the framework.</p>
          </div>
