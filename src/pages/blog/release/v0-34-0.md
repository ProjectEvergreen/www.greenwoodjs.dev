...
abstract: Dynamic routing for SSR and SSG, Lit SSR enhancements, and experimental JSX templating and reactivity support for WCC.
published: 2026-7-14
coverImage: /assets/dynamic-routing.svg
layout: blog
---
...
<img src="/assets/dynamic-routing.svg" style="display:block; width: 20%; margin: 10px auto;" alt="Brackets with database logo"/>
...
>
> - [tRPC demo](https://github.com/thescientist13/greenwood-trpc)
> - [Hacker News clone](https://github.com/thescientist13/greenwood-hackernews)
...
When enabling the `inferredObservability` option in the [plugin's configuration object](/docs/plugins/jsx/#installation) and in your custom element definition file, TC39 Signals will be available for reactivity.
...
> Check out our [example repo](https://github.com/thescientist13/greenwood-jsx) to see a demonstration of using this plugin.

## Lit SSR Enhancements

In this release, Greenwood has made a number of enhancements to better leverage some Lit's new SSR capabilities.

> Note: This plugin is still limited by [known caveats](https://github.com/ProjectEvergreen/greenwood/blob/master/packages/plugin-renderer-lit/README.md#caveats) with Lit's own SSR support, in particular around async work.
...
> See [this example repo](https://github.com/thescientist13/greenwood-lit-ssr) to see a demonstration of all these capabilities.
