...
> ⚠️ This feature is currently not supported with TypeScript >= 7.x. Please follow along with [this issue](https://github.com/ProjectEvergreen/greenwood/issues/1702) for more information and to follow along with the work.
